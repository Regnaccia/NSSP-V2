# DL-ARCH-V2-004 - Modello di accesso utente, ruoli e canali client
...
- Il prossimo task naturale e l'implementazione del primo slice `browser auth` coerente con questo modello, dopo il bootstrap DB interno.
