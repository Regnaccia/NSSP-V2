"""sync layer: sync_produzioni_storiche (TASK-V2-029)

Revision ID: 20260407010
Revises: 20260407009
...
revision = "20260407010"
down_revision = "20260407009"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    op.drop_table("sync_produzioni_storiche")
