"""
Core slice `warnings` V1 (TASK-V2-076, TASK-V2-077, TASK-V2-081, DL-ARCH-V2-029, TASK-V2-091, TASK-V2-122).
...
- is_missing_raw_bar_length: condizione MISSING_RAW_BAR_LENGTH (raw_bar_length_mm None o <= 0)
- WarningItem: read model canonico warning
- list_warnings_v1: query Core — genera NEGATIVE_STOCK, INVALID_STOCK_CAPACITY, MISSING_RAW_BAR_LENGTH
