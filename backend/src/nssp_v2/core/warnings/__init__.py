"""
Core slice `warnings` V1 (TASK-V2-076, TASK-V2-077, TASK-V2-081, DL-ARCH-V2-029).
...
- list_warnings_v1: query Core — genera warning NEGATIVE_STOCK per articoli con stock < 0
